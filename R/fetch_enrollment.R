...
# data from West Virginia.
#
# Data is sourced from West Virginia Department of Education (WVDE) School
# Finance Data PDFs which contain FTE enrollment by grade and headcount
...
#'
#' Downloads and processes enrollment data from the West Virginia Department
...
#'   district_id, district_name, and enrollment counts by grade.
