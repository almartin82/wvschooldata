...
**[Full documentation](https://almartin82.github.io/wvschooldata/)** —
...
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| **Enrollment**     | 2023-2024 | [`fetch_enr()`](https://almartin82.github.io/wvschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/wvschooldata/reference/fetch_enr_multi.md) | State, district. Grade level                |
| Assessments        | —         | —                                                                                                                                                                                 | Not yet available                           |
| Graduation         | —         | —                                                                                                                                                                                 | Not yet available                           |
| **Directory**      | current   | [`fetch_directory()`](https://almartin82.github.io/wvschooldata/reference/fetch_directory.md)                                                                                     | Schools. Name, address, phone, grades, type |
...
> See
> [DATA-CATEGORY-TAXONOMY.md](https://almartin82.github.io/wvschooldata/DATA-CATEGORY-TAXONOMY.md)
...
- [Full documentation](https://almartin82.github.io/wvschooldata/) — all
  15 stories with interactive charts
- [Function
  reference](https://almartin82.github.io/wvschooldata/reference/)
