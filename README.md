...
<!-- badges: start -->
[![R-CMD-check](https://github.com/almartin82/wvschooldata/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/almartin82/wvschooldata/actions/workflows/R-CMD-check.yaml)
[![Python Tests](https://github.com/almartin82/wvschooldata/actions/workflows/python-test.yaml/badge.svg)](https://github.com/almartin82/wvschooldata/actions/workflows/python-test.yaml)
[![pkgdown](https://github.com/almartin82/wvschooldata/actions/workflows/pkgdown.yaml/badge.svg)](https://github.com/almartin82/wvschooldata/actions/workflows/pkgdown.yaml)
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental)
<!-- badges: end -->

West Virginia educates roughly 250,000 students across 55 county school districts -- one for each county. From the coalfields of McDowell to the Eastern Panhandle suburbs of DC, here are fifteen stories hiding in the data.

Part of the [njschooldata](https://github.com/almartin82/njschooldata) family.

**[Full documentation](https://almartin82.github.io/wvschooldata/)** — all 15 stories with interactive charts, getting-started guide, and complete function reference.
...
### 1. Coal country has the smallest districts
...
![Coal country districts](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/growth-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#coal-country-has-the-smallest-districts)

---

### 2. The Eastern Panhandle has the largest suburban districts
...
![Eastern Panhandle districts](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/regional-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#the-eastern-panhandle-has-the-largest-suburban-districts)

---

### 3. The urban-rural divide is minimal
...
![Urban-rural comparison](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/urban-rural-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#the-urban-rural-divide-is-minimal)
...
|----------|-------|----------|---------|
| **Enrollment** | 2023-2024 | `fetch_enr()` / `fetch_enr_multi()` | State, district. Grade level |
| Assessments | — | — | Not yet available |
| Graduation | — | — | Not yet available |
| **Directory** | current | `fetch_directory()` | Schools. Name, address, phone, grades, type |
...
- [Full documentation](https://almartin82.github.io/wvschooldata/) — all 15 stories with interactive charts
- [Function reference](https://almartin82.github.io/wvschooldata/reference/)

## Data Notes

**Data Source:** [West Virginia Department of Education School Finance Data](https://wvde.us/about-us/finance/school-finance/school-finance-data/)
...
**Structure:**
- 55 county school districts (one per county, constitutionally mandated)
- District-level data only (no school-level data in PDFs)
- Grade-level FTE enrollment with headcount totals

**Suppression:** No suppression rules noted in the data

**Known Issues:**
- 2022 data was never published by WVDE
- Historical PDFs (2013-2021) removed from WVDE website
- FTE counts may have decimals due to part-time enrollment

## Deeper Dive

---

### 4. West Virginia educates around 250,000 students
...
![Statewide enrollment chart](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/statewide-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#west-virginia-educates-around-250000-students)

---

### 5. Kanawha County is the largest district
...
![Top districts chart](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/top-districts-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#kanawha-county-is-the-largest-district)

---

### 6. Small counties dominate the landscape
...
![District size distribution](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/demographics-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#small-counties-dominate-the-landscape)

---

### 7. McDowell County exemplifies Appalachian decline
...
### 8. High school enrollment patterns
...
### 9. Berkeley County is the fastest-growing region
...
### 10. Kindergarten enrollment signals future trends
...
#> K is 3.3% different from 12th grade
```

---

### 11. 55 districts create administrative structure
...
### 12. Kanawha County (Charleston) is the state capital's district
...
![Kanawha enrollment chart](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/charleston-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#kanawha-county-charleston-is-the-state-capitals-district)
...
![Northern Panhandle chart](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/northern-panhandle-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#the-northern-panhandle-steel-town-legacy)
...
![Grade wave chart](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/grade-wave-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#grade-level-enrollment-by-benchmark-grades)
...
![Future enrollment chart](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks_files/figure-html/future-chart-1.png)

[(source)](https://almartin82.github.io/wvschooldata/articles/enrollment_hooks.html#the-future-is-written-in-demographics)
